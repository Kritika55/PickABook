...
public class ProductController {
    ...
    private final  com.example.pick_a_book_indi.validator.ProductValidator productValidator;
    private final CategoryService categoryService;

    @Autowired
    public ProductController(ProductService productService,  com.example.pick_a_book_indi.validator.ProductValidator productValidator, CategoryService categoryService) {
